  ...
  return (
    <div>
      <section className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <p className="mb-5 text-2xl font-medium text-gray-900 dark:text-white">
          Data Penulis
        </p>
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {authors.length > 0 ? (
                  ...
                  <p className="m-5 text-center">Data tidak ditemukan.</p>
                )}
              </tbody>
            </table>
          </div>
          ...
          >
            ...
            <ul className="inline-flex items-stretch -space-x-px">
              ...
              <li>
                ...
                >
                  <span className="sr-only">Sesudah</span>
                  <svg
                    className="w-5 h-5"
                    aria-hidden="true"
                    fill="currentColor"
