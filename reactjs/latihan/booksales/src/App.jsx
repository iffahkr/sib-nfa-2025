      ...
      <div className="container">
        <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
          ...
          <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li>
              <a href="./App.jsx" className="nav-link px-2">
                Home
              </a>
            </li>
            <li>
              <a href="./Book.jsx" className="nav-link px-2">
                Book
              </a>
            </li>
            <li>
              ...
              <div className="col">
                <div className="card shadow-sm">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Memperkenalkan ajaran Stoikisme dalam konteks kehidupan modern. Dengan bahasa yang ringan, membantu pembaca mengelola emosi negatif dan membentuk mental yang tangguh dalam menghadapi tantangan hidup.</p>
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="btn-group">
                        <button type="button" className="btn btn-sm btn-outline-secondary">
                          View
